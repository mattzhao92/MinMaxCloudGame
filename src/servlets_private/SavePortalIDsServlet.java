...
public class SavePortalIDsServlet extends HttpServlet {
	...
	public void doPost(HttpServletRequest req, HttpServletResponse resp) 
		...
		Key newIDsKey = KeyFactory.createKey("PlayerList", "MyPlayerList");

	    Query query = new Query("lastTurn", newIDsKey);
		...
		Entity newIDs = new Entity("Player", newIDsKey);
